...
import collectionEkkel.Orange;

public class InterfaceLinkedListTest {
	

	public static void main(String[] args) {
		final InterfaceLinkedList<Integer> testInstance = new InterfaceLinkedList<Integer>();
			testInstance.add(1);
			testInstance.add(2);
			testInstance.add(3);
			testInstance.add(4);	
        ...
        System.out.println( listIterator.next());
         listIterator.set(0);
        System.out.println( testInstance.get(2));
        System.out.println( listIterator.previous());
        //System.out.println( listIterator.previous());
        listIterator.set(9);
        System.out.println( testInstance.get(1));
        System.out.println();
		...
		final ListIterator<Integer> liter = ll.listIterator(2);
