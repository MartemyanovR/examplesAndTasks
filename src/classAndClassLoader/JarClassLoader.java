 ...
 * Класс неоптимален -так как в нем загружаются все классы из Jar, даже если они не вызываются
 *
 * @author Pavel
 *
 */
...
public class JarClassLoader extends ClassLoader {
	//Кэш представлен в виде HashMap где названию соответствует класс
	        ...
	        try {           
	            ...
	            while (entries.hasMoreElements()) {
	                ...
	                if (match(normalize(jarEntry.getName()), packageName)) {           
	                    ...
	                    if (classData != null) {
	                    	/*
	                    	 * Метод defineClass служит для создания класса из загруженного байт-кода.
	                    	 *  Им осуществляется валидация загруженного байт-кода и анализ зависимостей.
	                    	 */
